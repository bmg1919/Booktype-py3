    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(upload_to='cover_images/', null=True, verbose_name='cover')),
            ],
            options={
                'verbose_name': 'Book',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('cid', models.CharField(default='', unique=True, max_length=40, verbose_name='cid')),
                ('attachment', models.FileField(upload_to=booki.editor.models.uploadCoverTo, max_length=2500, verbose_name='filename')),
                ('filename', models.CharField(default='', max_length=250, verbose_name='file name')),
                ...
                ('book', models.ForeignKey(verbose_name='book', to='editor.Book', null=True, on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ManyToManyField(related_name='members', verbose_name='members', to=settings.AUTH_USER_MODEL, blank=True)),
                ('owner', models.ForeignKey(verbose_name='owner', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(verbose_name='book', to='editor.Book', null=True, on_delete=models.CASCADE)),
                ('group', models.ForeignKey(verbose_name='group', to='editor.BookiGroup', null=True, on_delete=models.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.SmallIntegerField(verbose_name='kind', choices=[(0, 'string'), (1, 'integer'), (2, 'text'), (3, 'date')])),
                ...
                ('book', models.ForeignKey(related_name='settings', verbose_name='book', to='editor.Book', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(verbose_name='book', to='editor.Book', on_delete=models.CASCADE)),
                ('status', models.ForeignKey(verbose_name='status', to='editor.BookStatus', on_delete=models.CASCADE)),
                ('version', models.ForeignKey(verbose_name='version', to='editor.BookVersion', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.OneToOneField(related_name='lock', to='editor.Chapter', on_delete=models.CASCADE)),
                ('user', models.ForeignKey(verbose_name='user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ('created',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wizz_options', models.TextField(default='', verbose_name='wizzard options')),
                ('book', models.ForeignKey(verbose_name='book', to='editor.Book', null=True, on_delete=models.CASCADE)),
                ('user', models.ForeignKey(verbose_name='user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='booktoc',
            name='chapter',
            field=models.ForeignKey(verbose_name='chapter', blank=True, to='editor.Chapter', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='booktoc',
            name='parent',
            field=models.ForeignKey(verbose_name='parent', blank=True, to='editor.BookToc', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='booktoc',
            name='version',
            field=models.ForeignKey(verbose_name='version', to='editor.BookVersion', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bookhistory',
            name='chapter',
            field=models.ForeignKey(verbose_name='chapter', to='editor.Chapter', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bookhistory',
            name='chapter_history',
            field=models.ForeignKey(verbose_name='chapter history', to='editor.ChapterHistory', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bookhistory',
        ...
        migrations.AddField(
            model_name='bookhistory',
            name='version',
            field=models.ForeignKey(verbose_name='version', to='editor.BookVersion', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bookcover',
            name='license',
            field=models.ForeignKey(verbose_name='license', to='editor.License', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bookcover',
        ...
        migrations.AddField(
            model_name='book',
            name='group',
            field=models.ForeignKey(verbose_name='group', to='editor.BookiGroup', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='book',
            name='language',
            field=models.ForeignKey(verbose_name='language', to='editor.Language', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='book',
            name='license',
            field=models.ForeignKey(verbose_name='license', blank=True, to='editor.License', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='book',
            name='owner',
            field=models.ForeignKey(verbose_name='owner', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='book',
            name='status',
            field=models.ForeignKey(related_name='status', verbose_name='status', to='editor.BookStatus', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='book',
            name='version',
            field=models.ForeignKey(related_name='version', verbose_name='version', to='editor.BookVersion', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='attributionexclude',
            name='book',
            field=models.ForeignKey(verbose_name='book', to='editor.Book', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='attributionexclude',
        ...
        migrations.AddField(
            ...
            name='book',
            field=models.ForeignKey(verbose_name='book', to='editor.Book', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='attachment',
            name='status',
            field=models.ForeignKey(verbose_name='status', to='editor.BookStatus', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='attachment',
